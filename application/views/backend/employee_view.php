				                        ...
				                        <div class="card-body">
                                           ...
                                           <div class="row">
                                            <div class="form-group col-md-6 m-t-5">
			                                    ...
			                                    <div class="form-group col-md-6 m-t-5">
			                                        <label>ESIC</label>
			                                        <input type="text" name="bima" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control form-control-line" placeholder="ESIC..." value="<?php if(!empty($salaryvalue->bima)) echo $salaryvalue->bima ?>"> 
			                                    </div>
			                                    <div class="form-group col-md-6 m-t-5">
			                                        <label>Tax</label>
